...
var DateTimePicker = /** @class */ (function (_super) {
    ...
    Object.defineProperty(DateTimePicker.prototype, "validity", {
         ...
         */
        get: function () {
            var inRange = utils_1.isInRangePicker(this.value, this.min, this.max);
    ...
    DateTimePicker.prototype.render = function () {
        ...
        var rootClassName = kendo_react_common_1.classNames('k-widget k-datetimepicker k-header', {
        ...
        return (React.createElement("div", { ref: function (div) { _this._element = div; }, className: rootClassName, onKeyDown: this.handleKeyDown, style: { width: width }, onFocus: this.handleFocus, onBlur: this.handleBlur },
            ...
            React.createElement(kendo_react_popup_1.Popup, { show: this.show, animate: this._wrapper !== null, anchor: this._wrapper || undefined, className: "k-datetime-container k-group k-reset", id: this._popupId, anchorAlign: {
                ...
                React.createElement(DateTimeSelector_1.DateTimeSelector, { ref: function (dateTimeSelector) { _this._dateTimeSelector = dateTimeSelector; }, cancelButton: cancelButton, value: this.value, onChange: this.handleValueChange, disabled: disabled, weekNumber: weekNumber, min: this.min, max: this.max, focusedDate: focusedDate, format: format }))));
    };
