    ...
    TimePart.prototype.render = function () {
        ...
        return (React.createElement("div", { className: rootClassName },
            React.createElement("div", { className: "k-time-header" },
                ...
                this.showNowButton() &&
                    React.createElement("button", __assign({ ref: function (btn) { _this._nowButton = btn; }, className: "k-button k-bare k-time-now", title: "Select Now" }, { 'aria-label': 'Select Now' }, { onClick: onNowClick, tabIndex: disabled ? -1 : 0 }), "NOW")),
