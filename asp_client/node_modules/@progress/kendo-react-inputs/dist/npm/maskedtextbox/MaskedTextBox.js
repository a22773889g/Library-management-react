...
var MaskedTextBox = /** @class */ (function (_super) {
        ...
        _this.setValidity = function () {
            if (_this.element) {
                _this.element.setCustomValidity(_this.validity.valid
                    ? ''
                    : _this.props.validationMessage || utils_1.validationMessage);
            }
        };
        return _this;
    }
    ...
    MaskedTextBox.prototype.render = function () {
        ...
        return this.props.label
            ? (React.createElement(kendo_react_common_1.FloatingLabel, { id: inputId, value: this.value, valid: isValid, placeholder: this.props.placeholder, label: this.props.label, children: component, style: { width: this.props.width } }))
            : component;
    };
